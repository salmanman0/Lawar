    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                code = data[i]['code']
                if (response['rw'] == rw && status== "diterima") {
                    nama = data[i]['nama']
        ...
        success: function (response) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if (surat == "all") {
                    ...
                    let status = data[i]['status-rw']
                    code = data[i]['code']
                    if (response['rw'] == rw && status == "diterima" && jenis == "Surat Keterangan Usaha") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    code = data[i]['code']
                    let status = data[i]['status-rw']
                    if (response['rw'] == rw && status == "diterima" && jenis == "Surat Keterangan Tidak Mampu") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    code = data[i]['code']
                    let status = data[i]['status-rw']
                    if (response['rw'] == rw && status == "diterima" && jenis == "Surat Keterangan Kematian") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
