    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                rw = data[i]['rw']
                code = data[i]['code']
                if (response['rw'] == rw && response['rt'] == rt) {
                    nama = data[i]['nama']
                ...
                else if (response['rw'] == rw && response['rt'] == "") {
                    nama = data[i]['nama']
                    tanggal = data[i]['tanggal_pengajuan']
                    waktu = data[i]['waktu_pengajuan']
                    status_rw = data[i]['status-rw']
        ...
        success: function (response) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                if (surat == "all") {
                    ...
                    rw = data[i]['rw']
                    code = data[i]['code']
                    if (response['rw'] == rw && response['rt'] == rt && jenis == "Surat Keterangan Usaha") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['rw'] == rw && response['rt'] == "" && jenis == "Surat Keterangan Usaha") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['lurah'] == "lurah" && jenis == "Surat Keterangan Usaha") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    rw = data[i]['rw']
                    code = data[i]['code']
                    if (response['rw'] == rw && response['rt'] == rt && jenis == "Surat Keterangan Tidak Mampu") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['rw'] == rw && response['rt'] == "" && jenis == "Surat Keterangan Tidak Mampu") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['lurah'] == "lurah" && jenis == "Surat Keterangan Tidak Mampu") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    rw = data[i]['rw']
                    code = data[i]['code']
                    if (response['rw'] == rw && response['rt'] == rt && jenis == "Surat Keterangan Kematian") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['rw'] == rw && response['rt'] == "" && jenis == "Surat Keterangan Kematian") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
                    ...
                    else if (response['lurah'] == "lurah" && jenis == "Surat Keterangan Kematian") {
                        nama = data[i]['nama']
                        tanggal = data[i]['tanggal_pengajuan']
                        waktu = data[i]['waktu_pengajuan']
                        status_rw = data[i]['status-rw']
